...
export default class Drafts extends Component {
    render() {
        ...
        const disqusConfig = {
            url: "http://localhost:3000/Drafts", //this.props.pageUrl
            identifier: "Drafts", //this.props.uniqueId
            title: "Drafts" //this.props.title
        }
                ...
                <div className="card-deck justify-content-center align-self-center draft-top-row">
                    ...
                    <div className="card">
                        <div className="card-body">
                            ...
                            <p className="card-text">5. Not a movie, but...Jennifer Lopez as a Fly Girl on in Living
                                Color</p>
                        </div>
                    </div>
                </div>
