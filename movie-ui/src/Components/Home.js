    ...
    <div>
        ...
        <div className="col-sm-4 home-card-title">
          <div className="card border-0">
            <div className="card-body">
              ...
              <a href="MovieOfTheWeek" className="btn btn-primary">Join the Discussion</a>
            </div>
          </div>
        </div>
      ...
      <div class="card-deck justify-content-center align-self-center">
        ...
        <div class="card">
          ...
          <div class="card-body">
            <a href={"Drafts"} class="card-title">This week's draft: Rom-Coms</a>
        ...
        <div class="card">
          ...
          <div class="card-body">
            <a href={"MostOverrated"} class="card-title">Overrated? You bet.</a>
